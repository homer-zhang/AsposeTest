...
{
    public class ComponentUserField : SegmentBase
    {
        /// <summary>
        /// 组件用户字段
        /// </summary>
        /// <param name="actionType"></param>
        public ComponentUserField(ActionType actionType)
        {
            SegmentName = "HY72_AG_KOMPL_USRFLD";
            this.Action = actionType;

            DataFields.Add(new FieldBase("ANR", "", 40, "", "组合订单/OP 号"));    //必填
            DataFields.Add(new FieldBase("ATK", "", 40, "", "物料编号"));       //必填
            DataFields.Add(new FieldBase("SLP", "", 10, "", "BOM item"));   //必填
